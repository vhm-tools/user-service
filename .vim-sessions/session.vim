...
inoremap <silent> <SNR>75_AutoPairsReturn =AutoPairsReturn()
...
map  <Plug>(ctrlp)
snoremap  "_c
nmap  yy :below horizontal terminal
nmap  tt :below vertical terminal
nnoremap <silent>  h :Rg
xmap  t [fzf-p]
nmap  t [fzf-p]
nmap <silent>  m :History
...
nnoremap <silent> [fzf-p]p :CocCommand fzf-preview.FromResources project_mru git
...
xnoremap <silent> <C-A> :call multiple_cursors#select_all("v", 0)
nnoremap <silent> <C-A> :call multiple_cursors#select_all("n", 1)
...
nnoremap <S-Right> :vertical resize -5
nnoremap <S-Up> :resize -5
nnoremap <S-Down> :resize +5
nnoremap <S-Left> :vertical resize +5
nnoremap <S-Tab> :bn " Next buffer file
...
set runtimepath+=~/.vim/bundle/everforest
...
set runtimepath+=~/.vim/bundle/vim-expand-region
set runtimepath+=~/.vim/bundle/auto-pairs
set runtimepath+=~/.vim/bundle/coc-eslint
set runtimepath+=~/.vim/bundle/vim-easymotion
set runtimepath+=~/.vim/bundle/vim-rest-console
set runtimepath+=~/.vim/bundle/vim-wakatime
set runtimepath+=~/.vim/bundle/vim-surround
set runtimepath+=~/.vim/bundle/gruvbox
set runtimepath+=/usr/local/Cellar/macvim/9.0.1276/MacVim.app/Contents/Resources/vim/vimfiles
set runtimepath+=/usr/local/Cellar/macvim/9.0.1276/MacVim.app/Contents/Resources/vim/runtime
set runtimepath+=/usr/local/Cellar/macvim/9.0.1276/MacVim.app/Contents/Resources/vim/vimfiles/after
set runtimepath+=~/.vim/after
set runtimepath+=~/.vim/bundle/Vundle.vim
set runtimepath+=~/.vim/bundle/Vundle.vim/after
set runtimepath+=~/.vim/bundle/everforest/after
...
set runtimepath+=~/.vim/bundle/typescript-vim/after
...
set runtimepath+=~/.vim/bundle/vim-closetag/after
set runtimepath+=~/.vim/bundle/vim-expand-region/after
set runtimepath+=~/.vim/bundle/auto-pairs/after
set runtimepath+=~/.vim/bundle/coc-eslint/after
set runtimepath+=~/.vim/bundle/vim-easymotion/after
set runtimepath+=~/.vim/bundle/vim-rest-console/after
...
silent only
silent tabonly
cd /private/var/www/html/coding/PERSONAL/vhm-tools/user-service
